...
const RecentMatchItem = ({ recentMatch }) => {
  ...
  const successCount = recentMatch.predictions.filter(
    (p) =>
      ...
      p.predictedScoreOfTeam2 == recentMatch.teams[2].team.score
  )
  const successRate =
  ...
  return (
    <>
      <Link
        ...
        className={`w-full -skew-x-[24deg] hover:-translate-y-1 hover:-translate-x-1 hover:bg-secondary-dark hover:bg-opacity-60 flex gap-1 md:gap-2 items-center justify-evenly bg-tertiary-dark px-2 md:px-3 py-2 md:py-3`}
      >
        <div
          id="dateTime"
          className="flex flex-col skew-x-[24deg] whitespace-nowrap gap-1 basis-[10%] items-center justify-evenly text-white-3 text-[10px] md:text-xs"
        >
        ...
        <div
          id="round"
          className="hidden sm:flex flex-col skew-x-[24deg] whitespace-nowrap gap-1 basis-[10%] items-center justify-evenly text-white-3 text-[10px] md:text-xs"
        >
        ...
        <div
          id="flags"
          className="flex flex-col skew-x-[24deg] basis-[5%] items-end gap-1 justify-center"
        >
          <img
            className="h-3 md:h-4 aspect-video"
        ...
        <div
          id="teams"
          className="flex flex-col skew-x-[24deg] gap-1 whitespace-nowrap basis-[40%] items-start justify-center text-white-1 text-xs md:text-sm"
        >
        ...
        <div
          id="score"
          className="flex flex-col skew-x-[24deg] gap-1 whitespace-nowrap basis-[5%] items-start justify-evenly text-white-1 text-xs md:text-sm"
        >
        ...
        <div
          id="predictions"
          className="py-1 md:py-2 skew-x-[24deg] rounded-lg whitespace-nowrap basis-[10%] px-1 md:px-2 bg-secondary-light flex justify-center items-center text-black-2 text-xs md:text-sm"
        >
          <p>{recentMatch.predictions.length}</p>
        </div>
        <div
          id="success"
          className="py-1 md:py-2 skew-x-[24deg] rounded-lg whitespace-nowrap basis-[10%] px-1 md:px-2 bg-green-light flex justify-center items-center text-black-2 text-xs md:text-sm"
        >
          <p>{successRate}%</p>
        </div>
        <div
          id="userPoints"
          className="flex skew-x-[24deg] justify-center items-center whitespace-nowrap basis-[10%] text-primary-light text-center text-xs md:text-sm"
        >
          {didPredict ? (
